#include "RefinedOpenCylindricalShellGenerator.h"

QString RefinedOpenCylindricalShellGenerator::generateGeoScript() const {
    QString script = R"(
SetFactory("Built-in");
...
Physical Volume("OpenCylindricalShell_Solid") = {keep_vols[]};
